...
export function OfficeNotificationsPage({ token }: Props) {
  ...
  function messageLabel(n: any) {
    ...
    if (key === 'rapportDeleteRequested') return t('rapportDeleteRequested')
    if (key === 'rapportDeleteApproved') return t('rapportDeleteApproved')
    if (key === 'rapportDeleteRejected') return t('rapportDeleteRejected')
    if (key === 'rapportPendingChef') return t('rapportPendingChef')
    if (key === 'rapportPendingWali') return t('rapportPendingWali')
    if (key === 'rapportResubmittedBypass') return t('rapportResubmittedBypass')
